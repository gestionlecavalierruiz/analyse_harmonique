...
#############################################################################
            elif i == gamme_majeur[1] and (n < 2 or n%9 == 1):
                progression_harmonique.append(accord_maj_fond[1])
            elif i == gamme_majeur[1] and (n < 3 or n%9 == 2):
                progression_harmonique.append(accord_maj_premier_renv[1])
            elif i == gamme_majeur[1] and (n < 4 or n%9 == 3) :
                 progression_harmonique.append(accord_maj_deuxie_renv[1])

            elif i == gamme_majeur[1] and (n < 10 and n%9 == 1):
               progression_harmonique.append(accord_maj_fond[1])
            elif i == gamme_majeur[1]  and (n < 19 and n%9 == 2):
                progression_harmonique.append(accord_maj_premier_renv[1])
            elif i == gamme_majeur[1]  and (n < 28 and n%9 == 3):
                progression_harmonique.append(accord_maj_deuxie_renv[1])
###############################################################################
#Options pour 2 V
###############################################################################
            elif i == gamme_majeur[1] and (n < 5 or  n%9 == 4) :
                progression_harmonique.append(accord_maj_fond[4])
            elif i == gamme_majeur[1] and (n < 6 or  n%9 == 5) :
                progression_harmonique.append(accord_maj_premier_renv[4])
            elif i == gamme_majeur[1] and (n < 7 or  n%9 == 6) :
                 progression_harmonique.append(accord_maj_deuxie_renv[4])

            elif i == gamme_majeur[1] and (n < 37 and n%9 == 4):
               progression_harmonique.append(accord_maj_fond[4])
            elif i == gamme_majeur[1]  and (n < 46 and n%9 == 5):
                progression_harmonique.append(accord_maj_premier_renv[4])
            elif i == gamme_majeur[1]  and (n < 55 and n%9 == 6):
                progression_harmonique.append(accord_maj_deuxie_renv[4])
###############################################################################
#Options pour 2 VII
###############################################################################
            elif i == gamme_majeur[1] and (n < 8 or  n%9 == 7) :
                progression_harmonique.append(accord_maj_fond[6])
            elif i == gamme_majeur[1] and (n < 9 or  n%9 == 8) :
                progression_harmonique.append(accord_maj_premier_renv[6])
            elif i == gamme_majeur[1] and (n < 10 or  n%9 == 0) :
                progression_harmonique.append(accord_maj_deuxie_renv[6])

            elif i == gamme_majeur[1] and (n < 64 and n%9 == 7):
               progression_harmonique.append(accord_maj_fond[6])
            elif i == gamme_majeur[1]  and (n < 73 and n%9 == 8):
                progression_harmonique.append(accord_maj_premier_renv[6])
            elif i == gamme_majeur[1]  and (n < 82 and n%9 == 0):
                progression_harmonique.append(accord_maj_deuxie_renv[6])
###############################################################################
#Options pour 3 III qui est 2
###############################################################################
            elif i == gamme_majeur[2] and (n < 2 or n%9 == 1):
                progression_harmonique.append(accord_maj_fond[2])
            elif i == gamme_majeur[2] and (n < 3 or n%9 == 2):
                progression_harmonique.append(accord_maj_premier_renv[2])
            elif i == gamme_majeur[2] and (n < 4 or n%9 == 3) :
                 progression_harmonique.append(accord_maj_deuxie_renv[2])

            elif i == gamme_majeur[2] and (n < 10 and n%9 == 1):
                progression_harmonique.append(accord_maj_fond[2])
            elif i == gamme_majeur[2] and (n < 19 and n%9 == 2):
                progression_harmonique.append(accord_maj_premier_renv[2])
            elif i == gamme_majeur[2] and (n < 28 and n%9 == 3):
                 progression_harmonique.append(accord_maj_deuxie_renv[2])
#############################################################################
#Options pour 3 I
#############################################################################
            elif i == gamme_majeur[2] and (n < 5 or  n%9 == 4) :
                progression_harmonique.append(accord_maj_fond[0])
            elif i == gamme_majeur[2] and (n < 6 or  n%9 == 5) :
                progression_harmonique.append(accord_maj_premier_renv[0])
            elif i == gamme_majeur[2] and (n < 7 or  n%9 == 6) :
                 progression_harmonique.append(accord_maj_deuxie_renv[0])

            elif i == gamme_majeur[2] and (n < 37 and n%9 == 4):
                progression_harmonique.append(accord_maj_fond[0])
            elif i == gamme_majeur[2] and (n < 46 and n%9 == 5):
                progression_harmonique.append(accord_maj_premier_renv[0])
            elif i == gamme_majeur[2] and (n < 55 and n%9 == 6):
                 progression_harmonique.append(accord_maj_deuxie_renv[0])
#############################################################################
#Options pour 3 VI
#############################################################################
            elif i == gamme_majeur[2] and (n < 8 or  n%9 == 7) :
                progression_harmonique.append(accord_maj_fond[5])
            elif i == gamme_majeur[2] and (n < 9 or  n%9 == 8) :
                progression_harmonique.append(accord_maj_premier_renv[5])
            elif i == gamme_majeur[2] and (n < 10 or  n%9 == 0) :
                progression_harmonique.append(accord_maj_deuxie_renv[5])

            elif i == gamme_majeur[2] and (n < 64 and n%9 == 7):
                progression_harmonique.append(accord_maj_fond[5])
            elif i == gamme_majeur[2] and (n < 73 and n%9 == 8):
                progression_harmonique.append(accord_maj_premier_renv[5])
            elif i == gamme_majeur[2] and (n < 82 and n%9 == 9):
                 progression_harmonique.append(accord_maj_deuxie_renv[5])
############################################################################
#Options pour 4 IV qui est 3
############################################################################
            elif i == gamme_majeur[3] and (n < 2 or n%9 == 1):
                progression_harmonique.append(accord_maj_fond[3])
            elif i == gamme_majeur[3] and (n < 3 or n%9 == 2):
                progression_harmonique.append(accord_maj_premier_renv[3])
            elif i == gamme_majeur[3] and (n < 4 or n%9 == 3) :
                 progression_harmonique.append(accord_maj_deuxie_renv[3])
...
############################################################################
                ...
                progression_harmonique.append(accord_maj_premier_renv[1])
                 ...
                 progression_harmonique.append(accord_maj_deuxie_renv[1])
            elif i == gamme_majeur[3] and (n < 37 and n%9 ==4) :
                progression_harmonique.append(accord_maj_fond[1])
            elif i == gamme_majeur[3] and (n < 46 and n%9 ==5 ) :
                progression_harmonique.append(accord_maj_premier_renv[1])
            elif i == gamme_majeur[3] and (n < 55 and n%9 ==6) :
                 progression_harmonique.append(accord_maj_deuxie_renv[1])
...
############################################################################
            ...
            elif i == gamme_majeur[3] and (n < 64 and n%9 ==7) :
                progression_harmonique.append(accord_maj_fond[6])
            elif i == gamme_majeur[3] and (n < 73 and n%9 ==8) :
                progression_harmonique.append(accord_maj_premier_renv[6])
            elif i == gamme_majeur[3] and (n < 82 and n%9 ==0) :
                progression_harmonique.append(accord_maj_deuxie_renv[6])
############################################################################
# Options pour 5 V
############################################################################
            ...
            elif i == gamme_majeur[4] and (n < 10 and n%9 ==1):
                progression_harmonique.append(accord_maj_fond[4])
            elif i == gamme_majeur[4] and (n < 19 and n%9 ==2):
                progression_harmonique.append(accord_maj_premier_renv[4])
            elif i == gamme_majeur[4] and (n < 28 and n%9 ==3):
                progression_harmonique.append(accord_maj_deuxie_renv[4])
############################################################################
#Options pour 5 III
############################################################################
            ...
            elif i == gamme_majeur[4] and (n < 37 and n%9 == 4):
                progression_harmonique.append(accord_maj_fond[2])
            elif i == gamme_majeur[4] and (n < 46 and n%9 == 5):
                progression_harmonique.append(accord_maj_premier_renv[2])
            elif i == gamme_majeur[4] and (n < 55 and n%9 == 6):
                progression_harmonique.append(accord_maj_deuxie_renv[2])
############################################################################
#Options pour 5 I
############################################################################
            ...
            elif i == gamme_majeur[4] and (n < 64 and n%9 == 7):
                progression_harmonique.append(accord_maj_fond[0])
            elif i == gamme_majeur[4] and (n < 73 and n%9 == 8):
                progression_harmonique.append(accord_maj_premier_renv[0])
            elif i == gamme_majeur[4] and (n < 82 and n%9 == 0):
                progression_harmonique.append(accord_maj_deuxie_renv[0])
############################################################################
#Options pour 6 VI
############################################################################
            ...
            elif i == gamme_majeur[5] and (n < 10 and n%9 == 3):
                progression_harmonique.append(accord_maj_fond[5])
            elif i == gamme_majeur[5] and (n < 19 and n%9 == 3):
                progression_harmonique.append(accord_maj_premier_renv[5])
            elif i == gamme_majeur[5] and (n < 28 and n%9 == 3):
                progression_harmonique.append(accord_maj_deuxie_renv[5])
############################################################################
#Options pour 6 IV
############################################################################
            ...
            elif i == gamme_majeur[5] and (n < 37 and n%9 == 4):
                progression_harmonique.append(accord_maj_fond[3])
            elif i == gamme_majeur[5] and (n < 46 and n%9 == 5):
                progression_harmonique.append(accord_maj_premier_renv[3])
            elif i == gamme_majeur[5] and (n < 55 n%9 == 6):
                progression_harmonique.append(accord_maj_deuxie_renv[3])
############################################################################
#Options pour 6 II
############################################################################
            ...
            elif i == gamme_majeur[5] and (n < 64 and n%9 == 7):
                progression_harmonique.append(accord_maj_fond[1])
            elif i == gamme_majeur[5] and (n < 73 and n%9 == 8):
                progression_harmonique.append(accord_maj_premier_renv[1])
            elif i == gamme_majeur[5] and (n < n%9 == 0):
                progression_harmonique.append(accord_maj_deuxie_renv[1])
############################################################################
#Options pour 7 VII
############################################################################
            ...
            elif i == gamme_majeur[6] and (n < 10 and n%9 == 1):
                progression_harmonique.append(accord_maj_fond[6])
            elif i == gamme_majeur[6] and (n < 19 and n%9 == 2):
                progression_harmonique.append(accord_maj_premier_renv[6])
            elif i == gamme_majeur[6] and (n < 28 and n%9 == 3):
                progression_harmonique.append(accord_maj_deuxie_renv[6])
############################################################################
# Options pour 7 V
############################################################################
...
############################################################################
            ...
            elif i == gamme_majeur[6] and (n < 64 and n%9 == 8):
                progression_harmonique.append(accord_maj_fond[2])
            elif i == gamme_majeur[6] and (n < 73 and n%9 == 8):
                progression_harmonique.append(accord_maj_premier_renv[2])
            elif i == gamme_majeur[6] and (n < 82 and n%9 == 0):
                progression_harmonique.append(accord_maj_deuxie_renv[2])
        n = n + 1
